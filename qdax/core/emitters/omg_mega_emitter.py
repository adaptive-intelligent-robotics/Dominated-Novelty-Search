...
class OMGMEGAEmitterState(EmitterState):
	...
	gradients_repertoire: GridPopulation
...
class OMGMEGAEmitter(Emitter):
	...
	def init(
		...
		gradients_repertoire = GridPopulation.init_default(
	...
	def state_update(
		...
		return emitter_state.replace(gradients_repertoire=gradients_repertoire)
