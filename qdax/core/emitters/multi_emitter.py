...
class MultiEmitter(Emitter):
	...
	) -> tuple[EmitterState | None, RNGKey]:
		"""
	...
	def emit(
		self,
		repertoire: Population | None,
		emitter_state: MultiEmitterState | None,
		random_key: RNGKey,
	...
	def state_update(
		self,
		emitter_state: MultiEmitterState | None,
		repertoire: Population | None = None,
		genotypes: Genotype | None = None,
		fitnesses: Fitness | None = None,
		descriptors: Descriptor | None = None,
		extra_scores: ExtraScores | None = None,
	) -> MultiEmitterState | None:
