...
class AntBlock(env.Env):
  ...
  * v0: Initial versions release (1.0.0)
  ...
  def __init__(self,
               ...
               **kwargs):
    config = (
      _SYSTEM_CONFIG_SPRING + BLOCK_CONFIG + ANT_BLOCK_COLLISIONS
      if legacy_spring
      else _SYSTEM_CONFIG
    )
...
"""
# config describing collisions of the block following Brax's config style
