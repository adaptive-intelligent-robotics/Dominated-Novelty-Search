...
class AntBlockMany(env.Env):
  ...
  * v0: Initial versions release (1.0.0)
  ...
  def __init__(self,
               ...
               **kwargs):
    config = (
      _SYSTEM_CONFIG_SPRING + BLOCK_CONFIG_1 + BLOCK_CONFIG_2 + BLOCK_CONFIG_3 + ANT_BLOCK_COLLISIONS
      if legacy_spring
      else _SYSTEM_CONFIG
    )
...
#     name: "Block"
#     colliders {
#         position { x: 15.0 y: 0.0 z: 0.5 }
#         box {
#             halfsize { x: 13.0 y: 13.0 z: 1.0 }
#         }
#     }
...
BLOCK_CONFIG_1 = """bodies {
    name: "Block1"
    colliders {
        position { x: -10.0 y: -10.0 z: 0.5 }
        box {
            halfsize { x: 8.0 y: 8.0 z: 1.0 }
        }
    }
    inertia { x: 10000.0 y: 10000.0 z: 10000.0 }
    mass: 1
...
BLOCK_CONFIG_2 = """bodies {
    name: "Block2"
    colliders {
        position { x: 15.0 y: 0.0 z: 0.5 }
        box {
            halfsize { x: 6.0 y: 18.0 z: 1.0 }
        }
    }
    inertia { x: 10000.0 y: 10000.0 z: 10000.0 }
    mass: 1
...
BLOCK_CONFIG_3 = """bodies {
    name: "Block3"
    colliders {
        position { x: -10.0 y: 15.0 z: 0.5 }
        box {
            halfsize { x: 12.0 y: 7.0 z: 1.0 }
        }
    }
    inertia { x: 10000.0 y: 10000.0 z: 10000.0 }
    mass: 1
...
# Config describing collisions of the blocks following Brax's config style
# Specific to the ant env
ANT_BLOCK_COLLISIONS = """collide_include {
    first: "$ Torso"
    second: "Block1"
}
collide_include {
