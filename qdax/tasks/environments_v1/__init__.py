...
from qdax.tasks.environments_v1.anttrap import AntTrap
from qdax.tasks.environments_v1.antblock import AntBlock
from qdax.tasks.environments_v1.antblock_many import AntBlockMany
from qdax.tasks.environments_v1.base_wrappers import QDEnv, StateDescriptorResetWrapper
from qdax.tasks.environments_v1.bd_extractors import (
	get_feet_contact_proportion,
	get_final_xy_position,
)
from qdax.tasks.environments_v1.init_state_wrapper import FixedInitialStateWrapper
from qdax.tasks.environments_v1.locomotion_wrappers import (
	AntOmniWrapper,
	FeetContactWrapper,
	NoForwardRewardWrapper,
	XYPositionWrapper,
)
from qdax.tasks.environments_v1.wrappers import (
	ClipRewardWrapper,
...
brax.v1.envs.register_environment("antblock", AntBlock)
brax.v1.envs.register_environment("antblockmany", AntBlockMany)
_qdax_custom_envs = {
	"hopper_uni": {
		"env": "hopper",
	...
	"ant_omni_nobound": {
		"env": "ant",
		"wrappers": [XYPositionWrapper, NoForwardRewardWrapper, AntOmniWrapper],
		"kwargs": [{"minval": None, "maxval": None}, {}, {}],
	},
	"anttrap_omni": {
		"env": "anttrap",
		"wrappers": [XYPositionWrapper, NoForwardRewardWrapper, AntOmniWrapper],
...
def create(
	...
	qdax_wrappers_kwargs: list | None = None,
	**kwargs: Any,
) -> brax.v1.envs.env.Env | QDEnv:
	...
	elif env_name in _qdax_custom_envs:
		# Create env
	...
	if fixed_init_state:
		env = FixedInitialStateWrapper(env, base_env_name)
	if eval_metrics:
