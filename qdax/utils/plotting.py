...
def get_voronoi_finite_polygons_2d(
	centroids: np.ndarray, radius: float | None = None
...
def plot_2d_map_elites_repertoire(
	...
	minval: jnp.ndarray,
	maxval: jnp.ndarray,
	repertoire_descriptors: jnp.ndarray | None = None,
...
def multiline(
	xs: Iterable, ys: Iterable, c: Iterable, ax: Axes | None = None, **kwargs: Any
) -> LineCollection:
