...
class GeneticAlgorithm:
	...
	) -> tuple[GAPopulation, EmitterState | None, RNGKey]:
		"""Initialize a GAPopulation with an initial population of genotypes.
	...
	def update(
		...
		random_key: RNGKey,
	) -> tuple[GAPopulation, EmitterState | None, Metrics, RNGKey]:
		"""
	...
	def scan_update(
		self,
		carry: tuple[GAPopulation, EmitterState | None, RNGKey],
		unused: Any,
	) -> tuple[tuple[GAPopulation, EmitterState | None, RNGKey], Metrics]:
